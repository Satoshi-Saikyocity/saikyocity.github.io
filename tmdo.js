...
, function(t, n, e) {
    ...
    if (e(7)) {
        var r = e(30)
          ...
          , Mt = function(t) {
            var n, e, r, i, o, u, c = x(t), a = arguments.length, s = a > 1 ? arguments[1] : void 0, l = void 0 !== s, h = j(c);
            if (void 0 != h && !_(h)) {
                for (u = h.call(c),
                r = [],
                n = 0; !(o = u.next()).done; n++)
          ...
          , Ct = {
            ...
            filter: function(t) {
                return jt(this, H(Ot(this), t, arguments.length > 1 ? arguments[1] : void 0))
            },
            find: function(t) {
          ...
          , Dt = function(t, n) {
            return Wt(t, n = m(n, !0)) ? l(2, t[n]) : G(t, n)
        }
          , Ut = function(t, n, e) {
            return !(Wt(t, n = m(n, !0)) && S(e) && b(e, "value")) || b(e, "get") || b(e, "set") || e.configurable || b(e, "writable") && !e.writable || b(e, "enumerable") && !e.enumerable ? B(t, n, e) : (t[n] = e.value,
            t)
        };
        mt || (U.f = Dt,
        D.f = Ut),
        ...
        t.exports = function(t, n, e, a) {
            ...
            b ? (v = e(function(t, e, r, i) {
                ...
                if (S(e)) {
                    if (!(e instanceof J || "ArrayBuffer" == (a = w(e)) || "SharedArrayBuffer" == a))
                        return bt in e ? At(v, e) : Mt.call(v, e);
                    o = e,
                    p = Et(r, n);
                    var g = e.byteLength;
                    if (void 0 === i) {
            ...
            h(_, "constructor", v)) : o(function() {
                ...
                s(t, v, f);
                var o;
                return S(e) ? e instanceof J || "ArrayBuffer" == (o = w(e)) || "SharedArrayBuffer" == o ? void 0 !== i ? new g(e,Et(r, n),i) : void 0 !== r ? new g(e,Et(r, n)) : new g(e) : bt in e ? At(v, e) : Mt.call(v, e) : new g(y(e))
            }),
            Y(m !== Function.prototype ? P(g).concat(P(m)) : P(g), function(t) {
                t in v || h(v, t, g[t])
            }),
            v.prototype = _,
            r || (_.constructor = v));
        ...
        !function(n, r) {
            t.exports = function() {
                ...
                function D(t) {
                    ...
                    this._subscribers = [],
                    h !== t && ("function" != typeof t && L(),
                    this instanceof D ? k(this, t) : W())
                }
                function U() {
                    var t = void 0;
                    if (void 0 !== e)
...
, function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, d, y, g) {
        ...
        }, x = n + " Iterator", _ = "values" == d, E = !1, O = t.prototype, P = O[l] || O["@@iterator"] || d && O[d], j = P || S(d), A = d ? _ ? S("entries") : j : void 0, k = "Array" == n ? O.entries || P : P;
...
, function(t, n, e) {
    "use strict";
    function r(t, n, e) {
        var r, i, o, u = new Array(e), c = 8 * e - n - 1, a = (1 << c) - 1, f = a >> 1, s = 23 === n ? W(2, -24) - W(2, -77) : 0, l = 0, h = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for (t = L(t),
        t != t || t === N ? (i = t != t ? 1 : 0,
        r = a) : (r = D(U(t) / B),
        t * (o = W(2, -r)) < 1 && (r--,
        o *= 2),
        t += r + f >= 1 ? s / o : s * W(2, 1 - f),
        t * o >= 2 && (r++,
        o /= 2),
        r + f >= a ? (i = 0,
        r = a) : r + f >= 1 ? (i = (t * o - 1) * W(2, n),
        r += f) : (i = t * W(2, f - 1) * W(2, n),
        r = 0)); n >= 8; u[l++] = 255 & i,
        i /= 256,
        n -= 8)
            ;
    ...
    if (g.ABV) {
        if (!w(function() {
            ...
            ;
            for (var $, q = I[k] = R[k], J = O(R), K = 0; J.length > K; )
                ($ = J[K++])in I || m(I, $, R[$]);
            y || (q.constructor = I)
        }
        var Y = new T(new I(2))
...
, function(t, n, e) {
    (function(t, r) {
        ...
        function M() {
            ...
            return [t.getDate(), W[t.getMonth()], n].join(" ")
        }
        function I(t, n) {
            return Object.prototype.hasOwnProperty.call(t, n)
        }
...
, function(t, n, e) {
    "use strict";
    var r, i, o, u, c = e(30), a = e(2), f = e(20), s = e(43), l = e(0), h = e(4), p = e(10), v = e(32), d = e(33), y = e(51), g = e(92).set, m = e(84)(), b = e(85), w = e(123), S = e(66), x = e(124), _ = a.TypeError, E = a.process, O = E && E.versions, P = O && O.v8 || "", j = a.Promise, A = "process" == s(E), k = function() {}, M = i = b.f, I = !!function() {
        try {
            var t = j.resolve(1)
        ...
        g.call(a, function() {
            ...
            if (o && (n = w(function() {
                A ? E.emit("unhandledRejection", i, t) : (e = a.onunhandledrejection) ? e({
                    promise: t,
                    reason: i
    ...
    e(55)("replace", 2, function(t, n, e, d) {
        ...
        , function(t, n) {
            ...
            for (var S = "", x = 0, _ = 0; _ < b.length; _++) {
                w = b[_];
                for (var E = String(w[0]), O = f(s(u(w.index), h.length), 0), P = [], j = 1; j < w.length; j++)
                    P.push(v(w[j]));
                var A = w.groups;
                if (p) {
...
, function(t, n, e) {
    ...
    : function(t) {
      ...
      , J = function(t, n, e) {
        ...
        n = S(n, !0),
        m(e),
        i(W, n) ? (e.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1),
        e = _(e, {
            enumerable: x(0, !1)
        })) : (i(t, C) || k(t, C, x(1, {})),
        t[C][n] = !0),
      ...
      , H = function(t) {
        ...
        return !(this === U && i(W, t) && !i(D, t)) && (!(n || !i(this, t) || !i(W, t) || i(this, C) && this[C][t]) || n)
    }
      , X = function(t, n) {
        if (t = w(t),
        n = S(n, !0),
        t !== U || !i(W, n) || i(D, n)) {
            var e = A(t, n);
            return !e || !i(W, n) || i(t, C) && t[C][n] || (e.enumerable = !0),
            e
        }
    }
      , Z = function(t) {
    ...
    for (var tt = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), nt = 0; tt.length > nt; )
        p(tt[nt++]);
    for (var et = j(p.store), rt = 0; et.length > rt; )
        d(et[rt++]);
    u(u.S + u.F * !B, "Symbol", {
        for: function(t) {
      ...
      , u = function() {
        ...
        return o(t, [{
            ...
            value: function(t) {
                this.x = t.left_x,
                this.y = t.left_y,
                t.data.width && t.data.height ? (this.width = t.data.width,
                this.height = t.data.height) : (this.width = Math.max.apply(Math, r(t.data.xys.map(function(t) {
                    return t[0]
                }))),
                this.height = Math.max.apply(Math, r(t.data.xys.map(function(t) {
                    return t[1]
                }))),
                this.points = t.data.xys)
            }
        }, {
            key: "draw",
            value: function(t) {
                this.points ? this.drawPolygonKind(t) : this.drawRectangleKind(t)
            }
        }, {
            key: "drawPolygonKind",
            value: function(t) {
                ...
                var n = this.points[0];
                t.beginPath(),
                t.moveTo(this.x + n[0], this.y + n[1]);
                for (var e = 1; e < this.points.length; e++)
                    t.lineTo(this.x + this.points[e][0], this.y + this.points[e][1]);
                t.closePath(),
                t.stroke(),
                t.fill()
            }
        }, {
            key: "drawRectangleKind",
            value: function(t) {
                t.strokeStyle = this.strokeColor(),
                t.fillStyle = this.fillColor(),
            ...
            key: "drawShapeName",
            value: function(t) {
                if (null != this.json.names) {
                    var n = []
                      , e = ""
                      , r = this.width;
                    this.x,
                    this.y,
                    Array.prototype.forEach.call(this.json.names, function(i) {
                        t.measureText(e + i).width <= r ? e += i : (n.push(e),
                        e = i)
                    }),
                    n.push(e),
                    n.forEach(function(n, e) {
                        window.drawShapeNameIndex % 2 ? t.fillStyle = "red" : t.fillStyle = "yellow",
                        t.font = "bold 9px sans-serif"
                    }),
                    window.drawShapeNameIndex += 1
                }
            }
        }]),
        t
        ...
        var u = function() {
          ...
          , s = function(n) {
            ...
            u(e, [{
                ...
                value: function(t) {
                    if (this.points)
                        this.addPolygonEdges(t, this.json.data.left_point_indices),
                        this.addPolygonEdges(t, this.json.data.right_point_indices);
                    else {
                        var n = .3 * -this.height
                          , e = this.height + 2 * Math.abs(-n);
                        this.addRectangleEdges(t, this.x + 0, this.y + n, 1, e),
                        this.addRectangleEdges(t, this.x + this.width, this.y + n, 1, e)
                    }
                }
            }, {
                key: "addRectangleEdges",
                value: function(t, n, e, r, i) {
                    this.height < this.width && (t.fillStyle = "lightgray",
                    t.fillRect(n, e, r, i))
                }
            }, {
                key: "addPolygonEdges",
                value: function(n, e) {
                    if (this.json.data.xys) {
                        var r = e[0]
                          , i = e[1]
                          , o = Math.abs(i[1] - r[1])
                          , u = r[0]
                          , c = Math.min(r[1], i[1]);
                        n.fillStyle = "lightgray",
                        n.fillRect(this.x + u, this.y + c - .3 * o, 1, 1.6 * o)
                    } else
                        t.error("[TMDOBlockView]おかしなJSON: " + this.json)
                }
            }, {
                key: "fillColor",
                value: function() {
                    return this.hasTrain ? "red" : "lightgray"
                }
            }, {
                key: "strokeColor",
                value: function() {
      ...
      , o = function() {
        ...
        return i(t, [{
            ...
            value: function(t) {
                this.x = t.center_x,
                this.y = t.center_y,
                this.text = t.data.caption,
                this.kind = t.data.kind
            }
        }, {
            key: "draw",
            value: function(t) {
                this.onPlatform ? (t.font = "bold 12px sans-serif",
                t.fillStyle = "black") : 105 === this.kind ? (t.font = "bold 14px sans-serif",
                t.fillStyle = "black") : 106 === this.kind ? (t.font = "bold 8px sans-serif",
                t.fillStyle = "black") : (t.font = "bold 14px sans-serif",
                t.fillStyle = "white"),
                t.textAlign = "center",
...
, function(t, n, e) {
    ...
    var i = function() {
      ...
      , c = function() {
        function t(n, e, i, o, u, c, a, f, s) {
            r(this, t),
            this.x = n,
            this.y = e,
            this.widths = i,
            this.width = i.reduce(function(t, n, e) {
                return 1 != e ? t + n : t
            }),
            this.height = o,
            this.kind = u,
        ...
        return i(t, [{
            ...
            value: function() {
                ...
                this.affiliation_en = null,
                this.num_of_cars = null,
                this.train_kind = null,
                this.delay_time = null,
                this.train_orchestration_number = null
            }
        }, {
            key: "setCaptions",
            value: function(t, n, e, r, i, o, u) {
                this.operation_number = t,
                this.affiliation_en = n,
                this.num_of_cars = e,
                this.train_kind = r,
                this.delay_time = i,
                this.train_orchestration_number = o
            }
        }, {
            key: "draw",
            value: function(t) {
                var n = this
                  , e = this.x;
                this.delay_time && this.drawDelayTime(t),
                this.widths.forEach(function(r, i) {
                    n.drawRectangles(t, e, r, i);
                    var o = void 0;
                    0 == i && n.operation_number ? o = ("000" + n.operation_number).slice(-3) : 1 == i && n.affiliation_en ? o = n.affiliation_en : 2 == i && n.num_of_cars && (o = 0 == n.num_of_cars ? "" : n.num_of_cars);
                    var c = u.default.color(n.train_kind);
                    n.drawCaption(t, o, e, n.y, r, n.height, c, i),
                    1 != i && (e += r)
                }),
                !this.train_orchestration_number || 26001 != this.lineId && 26002 != this.lineId || this.trainOrchestrationNumber(t),
                !0 === this.outer_frame && this.drawOuterFrame(t)
            }
        }, {
            key: "drawRectangles",
            value: function(t, n, e, r) {
                var i = this.height
                  , o = this.y;
                t.lineWidth = 1,
                1 != r && 2 != r || (i = this.height / 2),
                2 == r && (o = this.y + i),
                t.strokeStyle = "white",
                t.fillStyle = "black",
                t.strokeRect(n, o, e, i),
                t.fillRect(n, o, e, i),
                t.restore(),
                t.save()
            }
            ...
            value: function(t) {
                ...
                t.strokeRect(this.x - 1, this.y - 1, this.width + 2, this.height + 2),
                t.restore(),
                t.save()
            }
        }, {
            ...
            value: function(t, n, e, r, i, o, u, c) {
                n && (1 == c || 2 == c ? (t.font = "bold 8px sans-serif",
                o = this.height / 2) : t.font = "bold 14px sans-serif",
                2 == c && (r = this.y + o),
                t.textAlign = "center",
                t.textBaseline = "middle",
                t.fillStyle = u,
                t.fillText(n, e + i / 2, r + o / 2, i),
                t.restore(),
                t.save())
            }
        }, {
            key: "drawDelayTime",
            value: function(t) {
                var n = this.delay_time > 99 ? 99 : this.delay_time;
                t.font = "bold 14px sans-serif",
                t.textAlign = "center",
                t.textBaseline = "middle",
                t.fillStyle = "red",
                t.fillText(n, this.x - this.width / 3, this.y + this.height / 2),
                t.restore(),
                t.save()
            }
        }, {
            key: "trainOrchestrationNumber",
            value: function(t) {
                t.font = "bold 14px sans-serif",
                t.textAlign = "center",
                t.textBaseline = "middle",
                t.fillStyle = "white",
                t.fillText(this.train_orchestration_number, this.x + this.width + this.width / 3, this.y + this.height / 2),
                t.restore(),
                t.save()
            }
        }]),
...
, , , , , function(t, n, e) {
    ...
    (function(t) {
        ...
        e(68);
        var r, i, o, u, c = e(69), a = e(97), f = (n(a),
        e(136)), s = e(354), l = n(s), h = e(353), p = n(h), v = e(357), d = n(v), y = e(355), g = n(y), m = e(356), b = n(m), w = e(343), S = n(w), x = [], _ = [], E = [], O = [], P = $(".js-tmdo-canvas")[0].getContext("2d");
        P.lineJoin = "bevel";
        var j = function() {
            return window.drawShapeNameIndex = 0,
            new c.Promise(function(n, e) {
                var i = new AWS.S3({
                  ...
                  , o = {
                    ...
                    Key: "assets/lines/" + r + "/alignment.json"
                };
                i.getObject(o, function(r, i) {
                    if (r)
                        t.error(r),
                        e();
                    else {
                        var o = JSON.parse(i.Body.toString());
                        n(o)
                    }
                })
            }
          ...
          , A = function(t) {
            return new c.Promise(function(n, e) {
                var i = new l.default(t)
                  , o = 0
                  , u = 0;
                i.blocks().forEach(function(t) {
                    var n = new p.default(t);
                    o = Math.max(o, n.x + n.width),
                    u = Math.max(u, n.y + n.height),
                    x.push(n)
                });
                var c = i.windows().shape;
                i.windows().objects.forEach(function(t) {
                    var n = t.start_y;
                    t.ids.forEach(function(e) {
                        var i = new d.default(t.left_x,n,c.widths,c.height,t.kind,t.outer_frame,e,t.window_kind,r);
                        108 !== i.kind && 109 !== i.kind || (o = Math.max(o, i.x + i.width),
                        u = Math.max(u, i.y + i.height),
                        _.push(i)),
                        n += c.height + 1
                    })
                }),
                i.platforms().forEach(function(t) {
                    var n = new g.default(t);
                    o = Math.max(o, n.x + n.width),
                    u = Math.max(u, n.y + n.height),
                    E.push(n)
                }),
                i.strings().forEach(function(t) {
                    var n = new b.default(t);
                    o = Math.max(o, n.x + 100),
                    u = Math.max(u, n.y + 100),
                    O.push(n)
                }),
                O.forEach(function(t) {
                    E.forEach(function(n) {
                        n.x <= t.x && t.x <= n.x + n.width && n.y <= t.y && t.y <= n.y + n.height && (t.onPlatform = !0)
                    })
                }),
                $(".js-tmdo-canvas").attr("width", o + 50).attr("height", u + 50),
                k(),
                n()
            }
            )
          ...
          , k = function() {
            var t = $(".js-tmdo-canvas").attr("width")
              , n = $(".js-tmdo-canvas").attr("height");
            P.clearRect(0, 0, t, n),
            x.filter(function(t) {
                return !t.hasTrain
            }).forEach(function(t) {
            ...
            x.forEach(function(t) {
                return t.drawShapeName(P)
            }),
            $(".js-updated-at").text(u)
        }
          , M = function n() {
            var e = new AWS.S3({
                region: AWSConfig.S3Region,
            ...
            e.getObject(r, function(e, r) {
                if (e)
                    ...
                    for (var i = JSON.parse(r.Body.toString()), o = 0; o < x.length; o++)
                        x[o].hasTrain = i.blocks.includes(x[o].json.names);
                    _.forEach(function(t) {
                        return t.clearCaptions()
                    }),
                    i.windows.forEach(function(n) {
                        var e = _.find(function(t) {
                            return t.id === n.id && t.window_kind === n.kind
                        });
                        void 0 !== e ? e.setCaptions(n.operation_number, n.affiliation_en, n.num_of_cars, n.train_kind, n.delay_time, n.train_orchestration_number) : t.error("jsonId:" + n.id, "jsonKind:" + n.kind)
                    }),
                    u = i.updated_at,
                    k()
                }
          ...
          , I = function() {
            switch (i) {
            case "toyoko":
                return ["小竹向原", "池袋", "東新宿", "新宿三丁目", "渋谷", "中目黒", "自由が丘", "田園調布", "武蔵小杉", "元住吉", "日吉", "菊名", "横浜", "元町・中華街", "新横浜", "西谷", "二俣川"];
            case "meguro":
                return ["目黒", "武蔵小山", "大岡山", "奥沢", "田園調布", "武蔵小杉", "元住吉", "日吉", "新横浜", "西谷", "二俣川"];
            case "dento":
                return ["渋谷", "桜新町", "用賀", "二子玉川", "溝の口", "梶が谷", "鷺沼", "あざみ野", "江田", "藤が丘", "長津田", "恩田", "中央林間"];
            case "oimachi":
                return ["大井町", "旗の台", "大岡山", "自由が丘", "上野毛", "二子玉川", "溝の口"]
            }
        }
          , T = function() {
            I().forEach(function(t) {
                return $(".js-station-buttons").append("<button class='btn d-inline-block station-button js-station-button'>" + t + "</button>")
            }),
            $(".js-station-button").on("click", function(n) {
                O.forEach(function(e) {
                    t.log($(n.currentTarget).text()),
                    e.text == $(n.currentTarget).text() && $(".tmdo_canvas").scrollLeft(e.x - $(window).width() / 3)
                })
            })
        }
          , F = function() {
            ...
            switch (i) {
            case "toyoko":
                t = '<span style="color:' + S.default.color("特") + '">特</span>&ensp;<span style="color:' + S.default.color("通") + '">通特</span>&ensp;<span style="color:' + S.default.color("急") + '">急</span>&ensp;<span style="color:' + S.default.color("Ｓ") + '">S-Train</span>&ensp;<span style="color:' + S.default.color("Ｆ") + '">Fライナー</span>&ensp;<span style="color:' + S.default.color("普") + '">普</span>&ensp;<span style="color:' + S.default.color("回") + '">回</span>';
                break;
            case "meguro":
                t = '<span style="color:' + S.default.color("急") + '">急行</span>&ensp;<span style="color:' + S.default.color("普") + '">普通(各駅停車)</span>&ensp;<span style="color:' + S.default.color("回") + '">回送</span>';
                break;
            case "dento":
                t = '<span style="color:' + S.default.color("急") + '">急行</span>&ensp;<span style="color:' + S.default.color("準") + '">準急</span>&ensp;<span style="color:' + S.default.color("普") + '">普通(各駅停車)</span>&ensp;<span style="color:' + S.default.color("回") + '">回送</span>';
                break;
            case "oimachi":
                t = '<span style="color:' + S.default.color("急") + '">急行</span>&ensp;<span style="color:' + S.default.color("Ｇ") + '">普通G(G各)</span>&ensp;<span style="color:' + S.default.color("普") + '">普通(各駅停車)</span>&ensp;<span style="color:' + S.default.color("回") + '">回送</span>'
            }
            $(".js-train-kind-color").html(t)
        };
        (0,
        f.getSession)().then(function(n) {
            window.loadingScreen.finish(),
            r = $(".js-tmdo-canvas").data("line-id"),
            i = $(".js-tmdo-canvas").data("line-symbol"),
            o = $(".js-tmdo-canvas").data("line-name"),
            T(),
            F(),
            j().then(function(t) {
                return A(t)
